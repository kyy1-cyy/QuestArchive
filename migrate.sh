...
SRC="/home17/jepp/home17/jepp/Quest Games"
DST="/home17/jepp/Quest Games"
...
[[ "$SRC" == "$DST" ]] && die "Source and destination cannot be the exact same directory"
...
export DST DRY_RUN LOG_FILE RED GREEN YELLOW CYAN BOLD RESET
