...
export const config = {
    ...
    B2: {
        ...
        KEY_ID: process.env.B2_KEY_ID || '004a6e72deedb150000000001',
        APP_KEY: process.env.B2_APP_KEY || 'K004MbeIqFQXlqMi/atqTYBgAZoMT9w',
        BUCKET_NAME: process.env.B2_BUCKET_NAME || 'quest-archive-main',
