...
export const config = {
    ...
    DONATIONS: {
        ENDPOINT: envFirst('B2_DONATIONS_ENDPOINT', 'DONATIONS_R2_ENDPOINT', 'B2_ENDPOINT', 'R2_ENDPOINT', 'BACKBLAZE_DONATIONS_ENDPOINT', 'BACKBLAZE_B2_ENDPOINT'),
        KEY_ID: envFirst('B2_DONATIONS_KEY_ID', 'B2_DONATIONS_APPLICATION_KEY_ID', 'DONATIONS_R2_ACCESS_KEY_ID', 'BACKBLAZE_DONATIONS_KEY_ID'),
        APP_KEY: envFirst('B2_DONATIONS_APP_KEY', 'B2_DONATIONS_APPLICATION_KEY', 'DONATIONS_R2_SECRET_ACCESS_KEY', 'BACKBLAZE_DONATIONS_APP_KEY'),
        BUCKET_NAME: envFirst('B2_DONATIONS_BUCKET_NAME', 'DONATIONS_R2_BUCKET_NAME', 'BACKBLAZE_DONATIONS_BUCKET_NAME') || 'quest-archive-donos'
    },
    GITHUB: {
